...
- **Health status**: Normal (≥95%), Borderline (90-94%), Low (<90%)
...
- `get_heart_rate_data` - HR time-series ⭐ NEW
- `get_workout_sessions` - Training sessions ⭐ NEW
- `get_daily_stress` - Stress tracking ⭐ NEW
- `get_spo2_data` - Blood oxygen ⭐ NEW
- `get_vo2_max` - Cardio fitness ⭐ NEW
- `get_tags` - User notes ⭐ NEW
...
- **NEW**: [DATA_COVERAGE.md](../../DATA_COVERAGE.md) - Complete data coverage guide
- **Updated**: [README.md](../README.md) - Added new example queries
- **Updated**: [PHASE2_QUICKSTART.md](../../PHASE2_QUICKSTART.md) - Extended tool documentation
...
### Use Case Coverage
- **Training**: ✅ Full coverage (sessions, HR, VO2 Max)
- **Sleep**: ✅ Full coverage (detailed sessions, SpO2)
- **Recovery**: ✅ Full coverage (stress, readiness, HRV)
- **Health Monitoring**: ✅ Full coverage (SpO2, HR, tags)
...
**Documentation**: See [DATA_COVERAGE.md](../../DATA_COVERAGE.md)
