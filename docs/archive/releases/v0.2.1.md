...
- **Exact Sleep Times**: Precise bedtime start/end timestamps (e.g., "21:30 → 07:15")
...
```
🛏️ Detailed Sleep Sessions (Last 3 days)
...
**Full Documentation:** See [PHASE2_QUICKSTART.md](../../PHASE2_QUICKSTART.md)
